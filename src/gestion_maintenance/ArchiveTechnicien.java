 ...
 * @author ADMIN
 */
public class ArchiveTechnicien extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ArchiveTechnicien.class.getName());

    /**
     * Creates new form ArchiveTechnicien
     */
    private int userId;
    private DefaultTableModel model;
    
    public ArchiveTechnicien(int userId) throws SQLException, IOException {
        initComponents();
        this.userId = userId;
   ...
   private void tableMouseClicked(java.awt.event.MouseEvent evt) {                                        
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ArchiveTechnicien().setVisible(true));
    }
